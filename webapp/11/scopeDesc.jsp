...
<a href="<%=request.getContextPath() %>/08/destination.jsp">destination이동</a>
</pre>
<%
	pageContext.setAttribute("pageAttr", "페이지 속성");
	request.setAttribute("requestAttr", "요청 속성");
	session.setAttribute("sessionAttr", "세션 속성");
	application.setAttribute("application", "어플리케이션 속성");
// 	pageContext.include("/08/destination.jsp");
	response.sendRedirect(request.getContextPath()+"/08/destination.jsp");
%>
</body>
</html>