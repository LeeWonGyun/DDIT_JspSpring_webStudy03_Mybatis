...
<title>07/autoRequest.jsp</title>
</head>
<body>
<h4>헤더를 이용한 페이지 갱신(->동기 요청 방식을 의미)</h4>
<%
...
<h4 id="server">현재 서버의 시간 : <span id="serverTime"></span></h4>
<h4 id="client">현재 클라이언트의 시간 : <span id="clientTime"></span></h4>
<!-- <h4><span id="timer"></span>초 뒤에 네이버로 이동</h4> -->
<pre>
	auto request 방법
	1. server side : Refresh 응답헤더
	<%--
		response.setIntHeader("Refresh", 1);
	--%>
	==> 전체가 새로고침 되기에 데이터가 날라감. 서버의 부하가 큼.
	2. client side 
