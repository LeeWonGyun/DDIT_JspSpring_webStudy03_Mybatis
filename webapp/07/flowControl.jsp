...
<head>
<meta charset="UTF-8">
<title>07/flowControl.jsp</title>
</head>
<body>
...
<pre>
	1.Request Dispatch : 원본 요청에 대한 정보를 가지고 분기. 서버사이드 위임구조
		...
		<%
			String destination = "/08/destination.jsp";
...
// 			rd.include(request, response);
	...
	2.Redirect : 원본 요청에 대한 정보가 페이지 이동전에 stateless 방식으로 삭제된 후에 이동하는 구조
		...
		주소를 클라이언트에서 사용하므로, Request Dispatch 방식이랑 다르게 ContextPath가 포함되어야 한다.
		<%--
			String location = request.getContextPath() + "/08/destination.jsp";
